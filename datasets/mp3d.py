...
class MP3Dnew(torch.utils.data.Dataset):
    def __init__(self):

        self.hydra_dataset_dir = str(BASE_DIR) + "data/mp3d_full_backend_2023_02_19/"
        ...
        self.file_names = glob.glob(self.hydra_dataset_dir + '/*_dsg.json', recursive=True)
